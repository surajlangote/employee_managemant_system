      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <div className="container-fluid">
          ...
          <div className='navbar-nav ms-auto'>
            <Link className='btn btn-outline-warning' state={{ marginLeft: "20px" }} to="/viewemp">View Emp</Link>
          </div>
          <div className='navbar-nav ms-auto'>
            <Link className='btn btn-outline-warning' state={{ marginLeft: "20px" }} to="/addemp">Add Emp</Link>
